...
class DashboardOverviewMobile extends StatelessWidget {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return DashboardCard(
          titleSize: size.width * 0.025,
          valueSize: size.width * 0.04,
          detailSize: size.width * 0.025,
          circleSize: size.width * 0.033,
